// Icon set shared across janosh's Svelte projects. Consolidated from matterviz, which
// held the largest curated set; its paths win where a name existed in both.
