...
| `sourceOfTruth`       | `'options'`                        | The selected array chosen to be the source for all the other selected arrays meaning changes to it will be reflected in the other arrays, of type `'options' \| 'labels' \| 'values'`.                                                                                                                                                                                           |
