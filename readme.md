...
| `selectedOptions`             | `[]`                 | Array of currently/pre-selected options when binding/passing as props respectively.                                                                                                                                                                                                                                                                                                                                               |
| `selectedLabels`       | `[]`                        | Labels of currently selected options.                                                                                                                                                                                                                                                                                                                                                                                             |
| `selectedValues`       | `'options'`                        | The selected array chosen to be the source for all the other selected arrays meaning changes to it will be reflected in the other arrays, of type `'options' \| 'labels' \| 'values'`.                                                                                                                                                                                                     |
| `sourceOfTruth`       | `[]`                        | Values of currently selected options.                                                                                                                                                                                           |
